 ...
 * generated in the com.webservice.webserviceexample package. 
...
public class ObjectFactory {
    ...
    private final static QName _Registrar_QNAME = new QName("http://webserviceexample.webservice.com/", "registrar");
    private final static QName _RegistrarResponse_QNAME = new QName("http://webserviceexample.webservice.com/", "registrarResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.webservice.webserviceexample
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webserviceexample.webservice.com/", name = "registrar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webserviceexample.webservice.com/", name = "registrarResponse")
